...
class TestPercentageGate:
    ...
    def test_percentage_gate_same_result_with_salt(self):
        ...
        gate = PercentageGate(
            percentage=percentage, entity_property=entity.entity_property, salt=salt
        )
    ...
    def test_percentage_gate_different_result_with_different_salt(self):
        ...
        salt1 = "salt1"
        gate1 = PercentageGate(
            percentage=percentage, entity_property=entity.entity_property, salt=salt1
        )
        result1 = gate1._check_gate(entity)

        salt2 = "salt2"
        gate2 = PercentageGate(
            percentage=percentage, entity_property=entity.entity_property, salt=salt2
        )
    ...
    def test_from_json_without_percentage_raises_value_error(self):
        json_data = {"entity_property": "user_id", "salt": "some_salt", "allow": True}
    ...
    def test_from_json_with_missing_entity_property(self):
        json_data = {"percentage": 50.0, "salt": "some_salt", "allow": True}
        gate = PercentageGate.from_json(json_data)
